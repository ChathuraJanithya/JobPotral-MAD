...
interface JobDao {
    ...
    @Query("UPDATE Job set title=:title , salary=:salary , requirements=:requirements , description=:description WHERE id = :id")
    fun updateJob(id:Int , title: String , salary:String , requirements:String , description: String) : Int
}